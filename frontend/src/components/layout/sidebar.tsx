...
const navigation = [
  ...
  { name: "Notebooks", href: "/notebooks", icon: NotebookIcon },
  ...
  { name: "Personas", href: "/personas", icon: PersonaIcon },
  { name: "Responses", href: "/responses", icon: ResponseIcon },
  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <div className="flex h-16 items-center px-6">
        <span className="text-lg font-semibold tracking-tight">NotebookLM</span>
      </div>
...
export function Sidebar() {
  ...
  return (
    <>
      {/* Desktop sidebar */}
      <aside className="hidden lg:fixed lg:inset-y-0 lg:flex lg:w-64 lg:flex-col border-r bg-background/80 apple-blur">
        <SidebarContent />
      </aside>
...
/* ── Minimal SVG icons (SF Symbols inspired, no emoji) ── */
